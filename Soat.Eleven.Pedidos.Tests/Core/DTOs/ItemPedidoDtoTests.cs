...
public class ItemPedidoDtoTests
{
    ...
    public void ItemPedidoInputDto_ImplicitConversion_DeveConverterParaItemPedido()
    {
        ...
        // Act
        Soat.Eleven.Pedidos.Core.Entities.ItemPedido itemPedido = dto;
    ...
    public void ItemPedidoInputDto_ImplicitConversion_DevePreservarTodosOsValores()
    {
        ...
        // Act
        Soat.Eleven.Pedidos.Core.Entities.ItemPedido resultado = dto;
    ...
    public void ItemPedidoOutputDto_ExplicitConversion_DeveConverterDeItemPedido()
    {
        // Arrange
        var produtoId = Guid.NewGuid();
        var itemPedido = new Soat.Eleven.Pedidos.Core.Entities.ItemPedido(produtoId, 5, 50.00m, 5.00m);
    ...
    {
        // Arrange
        var itemPedido = new Soat.Eleven.Pedidos.Core.Entities.ItemPedido(
